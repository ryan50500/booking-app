    ...
    <div className="bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 text-indigo-100">
              Track applications, manage interview rounds, and prepare smarter
            </p>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">
            Everything you need during your job search
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Log every application with status, source, contact details, and notes in one place
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                See at a glance which stage each application is at — applied, screening, interview, offer
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Build a personal Q&amp;A library — behavioural, technical, system design — searchable before any call
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-indigo-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-indigo-100">
            Stop losing track. Start your job search log today.
          </p>
          <Link
            to="/register"
